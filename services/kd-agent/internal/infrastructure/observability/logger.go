// Package observability initialises the structured logger for kd-agent.
...
// NewLogger constructs a *slog.Logger configured for the application log level
// defined in Config. The logger writes JSON to stdout.
